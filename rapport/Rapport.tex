...
indebærer af knapper til manøvrering på kortet, tekst-bar til visning af den vej
musen pejer på samt selve kortet. Selve kortet (\class{Canvas}) er implementeret
...
events der kommer når brugeren bruger musen, ændrer på vinduet's størrelse eller
