...
trække en ``kasse'' hen over det, man vil zoome ind på, og slippe museknappen.
...
det vise mere i enten højden eller i bredden.
\subsection{Navigationsknapper}
Det er muligt at navigere rundt på kortet ved hjælp af knapperne på GUI. Når
der klikkes på knapperne, bevæger vinduet sig i den retning vist af pilen på knappen.
...
at man trykker på Escape-tasten. Dette gør det nemmere at navigere på kortet, hvis
...
Vi har valgt ikke at gøre det muligt at specificere, hvilke typer veje, man vil have
...
i flere dele, som arbejder sammen for at få programmet til at køre. En måde,
...
som gør det nemt at overskue koden, og man deler ansvaret ud på forskellige klasser,
...
feltet \field{bounds}, der er det rektangel af kortet, der vises i øjeblikket.
...
\class{QuadTree} et rektangel, hvorefter den så returnerer et \class{Set} af de
veje, som ligger indenfor det rektangel. Dette betyder, at vi undgår at løbe
...
specifikke mængder af veje, hver \class{QuadTreeNode} kan indeholde.

Vi har besluttet at vise en stor del af vejene, selv når vi er i yderste
zoomniveau. Det har vi besluttet, fordi vi ikke har nogen features, som kræver,
...
Det
er muligt for brugeren at trække et rektangel i vinduet med musen for at zoome
ind på en bestemt del af kortet. For at undgå at skulle gentegne hele kortet,
hver gang brugeren trækker rektanglet lidt større, tegner \class{Canvas} kortet
på et off-screen \class{BufferedImage}, og bruger derefter dette billede til at
tegne sammen med rektanglet. På den måde kan vinduet gentegnes på konstant tid i
denne situation. 
