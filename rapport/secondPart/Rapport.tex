...
anything in the IndexMinPQ implementation that takes integers as values, this is not
...
that the user has selected, we have created the Evaluator class. This must be passed to
the pathfinding and is responsible for transforming the KrakEdge to a value that can
