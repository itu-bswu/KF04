...
\includegraphics[height=1.3em]{images/westbutton.png} or press the \class{left
arrow key} on the keyboard. This goes for all four directions. Figure
...
panel or the \class{i} key on the keyboard.
...
\includegraphics[height=1.5em]{images/zoomoutbutton.png} button or the \class{o} 
key on the keyboard. To return to the startup view (showing the entire map of
Denmark) press the \class{ESC} key on the keyboard. 
\section{Route find}
\label{MAN-RF}
