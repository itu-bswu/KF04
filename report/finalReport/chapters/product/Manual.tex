...
\includegraphics[height=1em]{images/westbutton.png}

or press the left arrow key. This goes for all 4
directions.
...
\includegraphics[height=1em]{images/zoominbutton.png}
...
To zoom-in, release the mousebutton.
...
\label{man-copenhagen}
\end{figure}

To zoom-out of the map, click the

\includegraphics[height=1em]{images/zoomoutbutton.png}

button. To return to the startup view
(showing the entire map of Denmark) press the esc button.
