...
\label{UIA}
% We probably should look at this phrasing?
...
\label{UIA-UIW}
% Yo dawg, I heard you like windows, so we put a window in your window, 
% so you can view while you view.
...
% Hvad menes der helt bestemt her?
...
% ``standard'' is probably irrelevant or should be re-phrased.
...
% Picture should be updated to newest version.
% Should probably be bigger / wider.
\begin{figure}[!ht]
\centering
...
% ``original view'' should probably be re-phrased, to make it clear what it is.
% menu bar function -> menu bar item ?
...
% Should probably be re-phrased (what does ``marked by the user'' mean?)
...
\label{UIA-NI-DRF}
% We should explain what a dynamic route finding is?
% Isn't our current path-finding dynamic in a way?
