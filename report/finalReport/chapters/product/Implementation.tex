...
have prioritized to make our design as simple, intuitive as possible. We used
...
\begin{figure}[!ht]
\centering
\includegraphics[width=1\linewidth]{images/UTMillu.png}
...
\label{Astar vs. Dijkstra example. The dashed lines are the direct distances,
