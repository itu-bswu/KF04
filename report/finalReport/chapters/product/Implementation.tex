...
\begin{figure}[!ht]
\centering
\includegraphics[width=0.5\linewidth]{UTMillu}
...
As mentioned in section \ref{IMPL-UTM} \nameref{IMPL-UTM}, we use UTM-conversion
to convert pixel values into the UTM values we need.
