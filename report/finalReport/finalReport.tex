...
two of our group members use MacOSX and they have experienced no problems with
our program besides what is mentioned in section \ref{PRC-BUGS}.
...
On MacOSX, and possibly also other operating systems, ``æ, ø, å, Å, Ø, and Æ''
from the dataset are displayed as weird characters. This is because the dataset
uses a different character set than the one used by MacOSX. We were developing a
fix for this, but it did not make it into the final version.
