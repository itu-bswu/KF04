	...
	private void addListeners(){
		...
		v.addInListener(new ActionListener(){
						public void actionPerformed(ActionEvent arg0){
							...
							m.updateBounds(new Rectangle2D.Double(old.x+ZOOM_LENGTH*old.width, //x is increased by the zoom_length in proportion to the width
		...
		v.addOutListener(new ActionListener(){
						public void actionPerformed(ActionEvent arg0){
							//Constructs a new rectangle using the maps bounds and the ZOOM_LENGTH variable.
							Rectangle2D.Double old = m.getBounds();
							m.updateBounds(new Rectangle2D.Double(old.x - old.width * ZOOM_LENGTH, //x is decreased by the zoom_length in proportion to the width
